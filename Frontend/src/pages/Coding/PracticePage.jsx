                  ...
                  {problems.length > 0 ? (
                    problems.map((problem, index) => (
                      ...
                      >
                        ...
                        <td className="text-lg text-gray-900 font-light px-6 py-4 whitespace-nowrap justify-center">
                          <Link to={problem.solutionLink || "#"}>
                            <img
                              src="https://img.icons8.com/color/24/null/one-page.png"
                              alt="Solution Icon"
                            />
                          </Link>
                        </td>
